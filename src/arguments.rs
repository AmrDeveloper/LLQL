...
pub fn print_help_list() {
    println!("LLQL is a SQL like query language to run on local files");
    println!();
    println!("Usage: LLQL [OPTIONS]");
    println!();
    println!("Options:");
    ...
    println!("-h,  --help                 Print LLQL help");
    println!("-v,  --version              Print LLQL Current Version");
}
